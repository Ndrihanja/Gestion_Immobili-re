                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    <div class="col" style="padding: 1rem; text-align:center;">
                                        <h2 class="page-title">Listes des Cité</h2>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table mb-0 ">
                                    <thead class="student-thread">
                                        <tr style="border: 1px solid #fafafa;">
                                            ...
                                            <th style="border-bottom: 1px solid black !important; padding: 1rem;">Agence</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border-bottom: 1px solid black !important; padding: 1rem;">{{ $list->agence_id }}</td>
                                        </tr>
                                        @endforeach
