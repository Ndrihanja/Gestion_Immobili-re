        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card comman-shadow">
                    <div class="card-body">
                        <form action="{{ route('vente/add/save') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <select class="form-control select  @error('logement_id') is-invalid @enderror" id="logement_id" name="logement_id">
                                            ...
                                            <option value="{{ $logement->id }}">{{ $logement->nom_logement }}</option>
                                            @endforeach
                                        </select>
                                        @error('logement_id')
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <select class="form-control select  @error('type_achat_id') is-invalid @enderror" id="type_achat_id" name="type_achat_id">
                                            ...
                                            <option value="{{ $type_achat->id }}">{{ $type_achat->achat }}</option>
                                            @endforeach
                                        </select>
                                        @error('type_achat_id')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>Prix </label>
                                        <input class="form-control @error('prix_total') is-invalid @enderror" type="text" name="prix_total" placeholder="Saisir le prix total" value="{{ old('prix_total') }}">
                                        @error('prix_total')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
