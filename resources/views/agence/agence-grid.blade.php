                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    <a href="{{ route('agence/list') }}" class="btn btn-outline-gray me-2"><i class="feather-list"></i></a>
                                    <a href="{{ route('agence/grid') }}" class="btn btn-outline-gray me-2 active"><i class="feather-grid "></i></a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="student-box flex-fill">
                                                ...
                                                <div class="student-content pb-0">
                                                    <h5><a href="student-details.html">Makafy AGC</a></h5>
                                                    <h6>Agence</h6>
                                                </div>
                                            </div>
                                        </div>
