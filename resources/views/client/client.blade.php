                ...
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Toutes les Clients</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    <a href="{{ route('client/list') }}" class="btn btn-outline-gray me-2 active"><i class="feather-list"></i></a>
                                    <a href="{{ route('client/grid') }}" class="btn btn-outline-gray me-2"><i class="feather-grid"></i></a>
                                    <a href="#" class="btn btn-outline-primary me-2"><i class="fas fa-download"></i> Télecharger</a>
                                    <a href="{{ route('client/add/page') }}" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="client-details.html">{{ $list->nom_client }}</a>
                                            </h2>
                                        </td>
                                        <td>{{ $list->prenom_client }}</td>
                                        <td>{{ $list->adresse }}</td>
                                        <td>{{ $list->phone }}</td>
                                        <td>{{ $list->email }}</td>
                                        <td>{{ $list->cin }}</td>
